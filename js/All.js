...
var _JobItemList = new Array("", "總幹事", "督導", "行政組長", "總會行政", "總會社工組長", "總會教研組長", "會計組長", "會計", "資訊組長", "出納", "主任", "副主任", "教學組長", "教師", "聽力組長", "聽力師", "社工組長", "社工", "中心行政");
...
var _ApplyJob = new Array("請選擇","總幹事","督導","行政組長","總會行政","總會社工組長","總會教研組長","會計組長","會計","資訊組長","出納","主任","副主任","教學組長","教師","聽力組長","聽力師","社工組長","社工","中心行政");
