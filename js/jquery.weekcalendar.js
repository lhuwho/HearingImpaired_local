            ...
            options: {
                ...
                eventHeader: function(calEvent, calendar) {
                    ...
                    if (displayTitleWithTime) {
                        if (calEvent.item != 0) {
                            return calendar.weekCalendar('formatTime', calEvent.start) + ': (' + calEvent.item + ')';
                            //return calendar.weekCalendar('formatTime', calEvent.start) + ': (' + calEvent.item + ') ' + calEvent.title;
                        } else {
