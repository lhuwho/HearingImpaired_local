    ...
    <div id="container">
		...
		<div id="content">
			    ...
			    <div id="mainSearchForm">
			        <table width="780" border="0">
			            <tr>
			                ...
			                <td width="260">性　　別 <select><option value="0">請選擇</option><option value="1">男</option><option value="2">女</option><option value="-">忽略</option></select></td>
			            ...
			            <tr>
			                ...
			                <td>年　　度 <input type="text" value="" size="10"/>～<input type="text" value="" size="10"/></td>
			                <td>檢核日期 <input class="date" type="text" name="name" size="10" />～<input class="date" type="text" name="name" size="10" /></td>
			            </tr>
			            <tr>
			...
			<div id="mainContent">
			    ...
			    <p style="background-color:#FFDF71;padding:0 10px;">請選擇班類型 <select name="class"><option value="0">個別班</option><option value="1">團體班</option></select>
			    <span style="float:right;">台北至德</span></p>
			    <p align="right"><input type="text" value="" size="5" /> 學年度</p>
			    <div id="page1">
			        <table class="tableText" width="780" border="0">
			            ...
			            <tr>
			                ...
			                <td><label><input type="radio" name="curriculum" value="1" /> 個別課</label>　　
			                    <label><input type="radio" name="curriculum" value="2" /> 聽能課</label>
			                </td>
			            </tr>
			            <tr>
			                <td colspan="4">&nbsp;</td>
			                    ...
			                    <table class="tableContact" width="780" border="0">
			                        ...
			                        <tbody>
			                            ...
			                            <tr>
			                                ...
			                                <td align="center"><select><option value="0">請選擇</option><option value="1">1</option><option value="2">2</option><option value="3">3</option><option value="4">4</option><option value="5">5</option><option value="-">忽略</option></select></td>
			                            </tr>
			                            <tr>
			                            ...
			                            <tr>
			                                ...
			                                <td align="center"><select><option value="0">請選擇</option><option value="1">1</option><option value="2">2</option><option value="3">3</option><option value="4">4</option><option value="-">忽略</option></select></td>
			                            </tr>
			                            <tr>
			                            ...
			                            <tr>
			                                ...
			                                <td align="center"><select><option value="0">請選擇</option><option value="1">1</option><option value="2">2</option><option value="3">3</option><option value="-">忽略</option></select></td>
			                            </tr>
			                            <tr>
			                            ...
			                            <tr>
			                                ...
			                                <td align="center"><select><option value="0">請選擇</option><option value="1">1</option><option value="-">忽略</option></select></td>
			                            </tr>
			                            <tr>
			                            ...
			                            <tr>
			                                ...
			                                <td align="center"><select><option value="0">請選擇</option><option value="1">1</option><option value="2">2</option><option value="-">忽略</option></select></td>
			                            </tr>
			                            <tr>
			            ...
			            <tr>
			                <td colspan="4"><br />貳、教學服務檢核表平均分數相關督導建議參考如下：<br />
                                ...
                                4. 總分成績<br />
                                <label><input type="radio" name="total" value="1" /> 75分以上：建議每學期例行教學督導觀摩課程1次、參與相關研討、必要時教師得提出需求</label><br />
			                    <label><input type="radio" name="total" value="2" /> 65-74分：督導人員向中心主管報告，增加督導看課次數或安排研討</label><br />
			                    <label><input type="radio" name="total" value="3" /> 64分以下：督導人員可協請中心主管、總幹事共同進行課程督導，增加督導看課次數或研討，同時提出具體改進的目標或方法，必要時得安排教學考核</label>
			                    <br /><br />
			                </td>
			            </tr>
			            <tr>
			                <td colspan="4">叁、得分統計<br />
			                    <table class="tableContact" width="780" border="0">
		                            ...
		                            <tr>
		                                <th>總　分</th>
		                                <td colspan="6"><input id="total1" type="text" value="" />　<input type="button" value="計算" onclick="calInspect(1)" /></td>
		                            </tr>
			                    </table><br />
			                </td>
			            </tr>
			    ...
			    <div id="page2" style="display:none;">
			        <table class="tableText" width="780" border="0">
			            ...
			            <tr>
			                <th>學生年齡</th>
			                <td><input type="text" value="" size="5" /> 歲至 <input type="text" value="" size="5" /> 歲</td>
			                <th>檢核日期</th>
			                <td><input type="text" class="date" value="" /></td>
			            </tr>
			            <tr>
			                <th>課　　別</th>
			                <td colspan="3"><label><input type="radio" name="curriculum" value="1" /> 團體課</label>　　
			                    <label><input type="radio" name="curriculum" value="2" /> 聽故事學語文課</label>　　
			                    <label><input type="radio" name="curriculum" value="3" /> 其它</label> <input type="text" value="" />
			                </td>
			            </tr>
			            <tr>
			                <td colspan="4">
			            ...
			            <tr>
			                <td colspan="4">叁、得分統計<br />
			                    <table class="tableContact" width="780" border="0">
		                            ...
		                            <tr>
		                                <th>得　分</th>
		                                <td><input type="text" value="" size="5" /> ／40</td>
		                                <td><input type="text" value="" size="5" /> ／15</td>
		                                <td><input type="text" value="" size="5" /> ／20</td>
		                                <td><input type="text" value="" size="5" /> ／8</td>
		                                <td><input type="text" value="" size="5" /> ／12</td>
		                                <td><input type="text" value="" size="5" /> ／4</td>
		                            </tr>
		                            <tr>
		                                <th>百分比</th>
		                                <td><input type="text" value="" size="10" /> %</td>
		                            ...
		                            <tr>
		                                <th>總　分</th>
		                                <td colspan="6"><input id="total2" type="text" value="" />　<input type="button" value="計算" onclick="calInspect(2)" /></td>
		                            </tr>
			                    </table><br />
			                </td>
			            </tr>
