<%@ Page Language="C#" AutoEventWireup="true" CodeFile="teacher_temperature_statistics.aspx.cs" Inherits="teacher_temperature_statistics" %>
...
<head runat="server">
	...
	<script type="text/javascript" src="./js/teacher_temperature_statistics.js"></script>
...
<body>
    ...
    <div id="container">
		...
		<div id="content">
			<div id="mainClass">行政管理&gt; 教師體溫統計</div>
