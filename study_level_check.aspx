		...
		<div id="content">
			...
			<div id="mainContent">
			    <div id="item1Content">
			        ...
			        <p>學生姓名 <input id="studentName" type="text" value="" size="15" readonly="readonly"/><span id="studentID" class="hideClassSpan"></span><span class="startMark">*</span>　　出生日期 <div id="studentbirthday"></div>　　
			            填寫人 <input type="text" value="" size="15" />　　填表日期 <input class="date" type="text" value="" size="10" /></p>
			        <table class="tableContact" width="780" border="0">
			            ...
			            <tr>
			                <td>個別化教育服務計畫進展狀況</td>
			                <td><select><option value="0">請選擇</option><option value="1">1</option><option value="2">2</option><option value="3">3</option><option value="4">4</option><option value="5">5</option></select></td>
			                <td><select><option value="0">請選擇</option><option value="1">1</option><option value="2">2</option><option value="3">3</option><option value="4">4</option><option value="5">5</option></select></td>
			                <td><p>5：教育計畫大多能在目標設定日期內全數達成，甚至超前<br />
                                3：教育計畫能在目標設定日期內至少達到7成，且其他未達到7成的目標，也至少能達到5成以上<br />
                                1：教育計畫只能達到5成或5成以下，許多目標皆需修訂或延續執行
			                </p></td>
			            </tr>
			            <tr>
			                <td>評估結果或進展（以本會評估工具為主）</td>
			                <td><select><option value="0">請選擇</option><option value="1">1</option><option value="2">2</option><option value="3">3</option><option value="4">4</option><option value="5">5</option></select></td>
			                <td><select><option value="0">請選擇</option><option value="1">1</option><option value="2">2</option><option value="3">3</option><option value="4">4</option><option value="5">5</option></select></td>
			                <td><p>5：整體評估接近或超過同年齡常模，整體學習進展相當明顯<br />
                                3：整體評估與同年齡常模有落差（雖仍有常模可對照）或有進展但整體學習進展速度普通<br />
                                1：整體評估無法與同齡常模對照或進展速度相當緩慢
			                </p></td>
			            </tr>
			            <tr>
			                <td>主要教學者教學執行狀況與成效</td>
			                <td><select><option value="0">請選擇</option><option value="1">1</option><option value="2">2</option><option value="3">3</option><option value="4">4</option><option value="5">5</option></select></td>
			                <td><select><option value="0">請選擇</option><option value="1">1</option><option value="2">2</option><option value="3">3</option><option value="4">4</option><option value="5">5</option></select></td>
			                <td><p>5：投入時間極多且教學效能佳，對教師交代之作業能有效進行<br />
			            ...
			            <tr>
			                ...
			                <td><select><option value="0">請選擇</option><option value="1">1</option><option value="2">2</option><option value="3">3</option><option value="4">4</option><option value="5">5</option></select></td>
			                <td><select><option value="0">請選擇</option><option value="1">1</option><option value="2">2</option><option value="3">3</option><option value="4">4</option><option value="5">5</option></select></td>
			                <td><p>5：會利用情境、創造情境，運用輸入技巧將教學目標融合於活動中，且能和孩子有良好的互動<br />
			            ...
			            <tr>
			                ...
			                <td><select><option value="0">請選擇</option><option value="1">1</option><option value="2">2</option><option value="3">3</option><option value="4">4</option><option value="5">5</option></select></td>
			                <td><select><option value="0">請選擇</option><option value="1">1</option><option value="2">2</option><option value="3">3</option><option value="4">4</option><option value="5">5</option></select></td>
			                <td><p>5：具良好的學習態度且有很高的溝通意願（智能表現在中上）<br />
                                3：具學習及溝通的意願，無智能或其它學習的障礙及困難<br />
                                1：明顯的學習困難（具其它疑似或明確的障礙）
			                </p></td>
			            </tr>
			            <tr>
			                <td>教學資源（聽語教學單位，例如：語言治療等）</td>
			                <td><select><option value="0">請選擇</option><option value="1">1</option><option value="2">2</option><option value="3">3</option><option value="4">4</option><option value="5">5</option></select></td>
			                <td><select><option value="0">請選擇</option><option value="1">1</option><option value="2">2</option><option value="3">3</option><option value="4">4</option><option value="5">5</option></select></td>
			                <td><p>5：除本會課程外尚有適切的療育單位或目前不需要其它的療育資源<br />
                                3：除本會課程外尚有其它療育資源，但在功能及協助上有限<br />
                                1：需要但未能安排到適切的療育資源
			                </p></td>
			            </tr>
			            <tr>
			                <td>相關療育資源（非聽語教學單位，例如：物理、職能治療、發展中心等）</td>
			                <td><select><option value="0">請選擇</option><option value="1">1</option><option value="2">2</option><option value="3">3</option><option value="4">4</option><option value="5">5</option></select></td>
			                <td><select><option value="0">請選擇</option><option value="1">1</option><option value="2">2</option><option value="3">3</option><option value="4">4</option><option value="5">5</option></select></td>
			                <td><p>5：沒有需求或已在適切的療育單位接受適當的相關療育服務<br />
			            ...
			            <tr>
			                ...
			                <td><select><option value="0">請選擇</option><option value="1">1</option><option value="2">2</option><option value="3">3</option><option value="4">4</option><option value="5">5</option></select></td>
			                <td><select><option value="0">請選擇</option><option value="1">1</option><option value="2">2</option><option value="3">3</option><option value="4">4</option><option value="5">5</option></select></td>
			                <td><p>5：情緒行為穩定、良好或情緒表現符合該年齡之一般行為<br />
			            ...
			            <tr>
			                ...
			                <td><select><option value="0">請選擇</option><option value="1">1</option><option value="2">2</option><option value="3">3</option><option value="4">4</option><option value="5">5</option></select></td>
			                <td><select><option value="0">請選擇</option><option value="1">1</option><option value="2">2</option><option value="3">3</option><option value="4">4</option><option value="5">5</option></select></td>
			                <td><p>5：聽力穩定，且定期接受聽力服務/諮詢<br />
                                3：聽力偶有變化，但多能即時察覺並接受聽力及相關醫療服務<br />
                                1：未接受定期聽力服務/諮詢
			                </p></td>
			            </tr>
			            <tr>
			                <td colspan="4" align="center">教師－備註/其它狀況說明<br /><textarea cols="80" rows="2"></textarea></td>
			            </tr>
			            <tr>
			                <td colspan="4" align="center">家長－備註/其它狀況說明<br /><textarea cols="80" rows="2"></textarea></td>
			            </tr>
			        </table>
			        <p class="btnP">
			    ...
			    <div id="item2Content">
			        ...
			        <p align="right">填寫人 <input type="text" value="" size="15" /></p>
			        <table class="tableContact" width="780" border="0">
			            <tr>
			            ...
			            <tr>
			                <td>教學服務需求評估</td>
			                <td>30</td>
			                <td align="center"><input type="text" value="" size="5" /></td>
			                <td align="center"><input type="text" value="" size="5" /></td>
			                <td align="center"><input type="text" value="" size="5" /></td>
			                <td><label><input type="radio" name="check1" value="" /> 高度（01-12分）</label>　
			                <label><input type="radio" name="check1" value="" /> 中度（13-22分）</label>　
			                <label><input type="radio" name="check1" value="" /> 低度（23-30分）</label></td>
			            </tr>
			            <tr>
			                <td>相關療育需求評估</td>
			                <td>05</td>
			                ...
			                <td align="center"><input type="text" value="" size="5" /></td>
			                <td align="center"><input type="text" value="" size="5" /></td>
			                <td><label><input type="radio" name="check2" value="" /> 高度（01-02分）</label>　
			                <label><input type="radio" name="check2" value="" /> 低度（03-05分）</label></td>
			            </tr>
			            <tr>
			                <td>情緒輔導需求評估</td>
			                <td>05</td>
			                ...
			                <td align="center"><input type="text" value="" size="5" /></td>
			                <td align="center"><input type="text" value="" size="5" /></td>
			                <td><label><input type="radio" name="check3" value="" /> 高度（01-02分）</label>　
			                <label><input type="radio" name="check3" value="" /> 低度（03-05分）</label></td>
			            </tr>
			            <tr>
			                <td>聽力服務需求評估</td>
			                <td>15</td>
			                ...
			                <td align="center"><input type="text" value="" size="5" /></td>
			                <td align="center"><input type="text" value="" size="5" /></td>
			                <td><label><input type="radio" name="check4" value="" /> 高度（01-12分）</label>　
			                <label><input type="radio" name="check4" value="" /> 中度（13-22分）</label>　
			                <label><input type="radio" name="check4" value="" /> 低度（23-30分）</label></td>
			            </tr>
			            <tr>
			                <td colspan="6" align="center" >其他（簡述說明特殊狀況或是其它說明及建議）：<br /><textarea cols="80" rows="2"></textarea><br /><br /></td>
			            </tr>
			        </table>
			        <p class="btnP">
			    ...
			    <div id="item3Content">
			        <p align="right" style="background-color:#FFDF71;padding:0 10px;">台北至德</p>
			        <p align="right">記錄者 <input type="text" value="" size="15" />　　記錄日期 <input class="date" type="text" value="" size="15" /></p>
			        <table class="tableContact2" width="780" border="0">
			            <tr>
			                <td colspan="6">（跨專業服務人員討論決議記錄）<br /><textarea cols="100" rows="5"></textarea><br /><br /></td>
			            </tr>
			            <tr>
			                <th>職稱</th>
			                <th>姓名</th>
